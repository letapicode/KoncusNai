...
def _torchaudio():
    """Load optional editing support only when an editing effect requests it."""
    import torchaudio
...
class EffectMixin:
    ...
    def pitch_shift(self, n_semitones: int, quick: bool = True):
        ...
        waveform, sample_rate = _torchaudio().sox_effects.apply_effects_tensor(
    ...
    def apply_codec(
        ...
        ValueError
            ...
            is thrown.
        """
        torchaudio_version_070 = "0.7" in _torchaudio().__version__
        ...
        if kwargs["format"] in ["vorbis", "mp3", "ogg", "amr-nb"]:
            ...
            augmented = torch.cat(
                [
                    _torchaudio().functional.apply_codec(
            ...
            augmented = _torchaudio().functional.apply_codec(
